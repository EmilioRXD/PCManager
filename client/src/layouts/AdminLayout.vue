      ...
      <nav class="sidebar-nav">
        <div class="nav-section">
          ...
          <router-link to="/admin" class="sidebar-link" exact-active-class="active">
            <AppIcon name="grid_view" size="18px" />
            Catálogo
          </router-link>
        </div>
        <div class="nav-section">
...
.breadcrumb-admin { font-size: 13px; color: var(--muted); }
