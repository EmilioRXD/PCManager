      ...
      <div class="qv-modal">
        ...
        <div class="qv-info">
          ...
          <div class="specs" style="display: flex; flex-wrap: wrap; gap: 5px">
            <span v-if="equipo?.procesador" class="spec-tag">{{
              equipo.procesador
            }}</span>
            <span v-if="equipo?.ram" class="spec-tag">{{ equipo.ram }}</span>
            <span v-if="equipo?.almacenamiento" class="spec-tag">{{
              equipo.almacenamiento
            }}</span>
            <span v-if="equipo?.tarjeta_grafica" class="spec-tag">{{
              equipo.tarjeta_grafica
            }}</span>
            <span v-if="equipo?.pantalla" class="spec-tag">{{
              equipo.pantalla
            }}</span>
